...
const ServiceCard = ({ service, onClick }) => {
  ...
  return (
    <div  
      className="relative items-center flex bg-white al dark:bg-gray-800 hover:bg-primary dark:hover:bg-primary hover:text-white rounded-lg shadow-lg transition-transform transform hover:scale-105 duration-300 cursor-pointer w-full  max-w-xs mx-auto"
      onClick={onClick}
